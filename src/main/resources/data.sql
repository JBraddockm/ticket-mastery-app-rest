...
INSERT INTO users (created_on, created_by, updated_on, updated_by, is_enabled, role_id, first_name, last_name, username,
                   gender, password, confirm_password, phone_number)
...
VALUES ('2023-12-30', 3, 1, current_timestamp, 1, null, null, 'OPEN', 'Task Detail', 'Task Sample ONE');

INSERT INTO tasks (assigned_date, assigned_employee_id, created_by, created_on, project_id, updated_by, updated_on,
                   status, task_detail, task_subject)
VALUES ('2023-12-30', 3, 1, current_timestamp, 1, null, null, 'COMPLETED', 'Task Detail', 'Task Sample TWO');
